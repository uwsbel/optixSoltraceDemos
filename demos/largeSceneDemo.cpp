...
void createSBT( SoltraceState &state )
{
    ...
    // Hitgroup program record
    {
        ...
        // Configure heliiostat SBT records
        ...
        OPTIX_CHECK( optixSbtRecordPackHeader(
            ...
            &hitgroup_records[sbt_idx] ) );
        hitgroup_records[ sbt_idx ].data.geometry_data.setParallelogram( state.receiver );
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        parseGeometryCSV(state, "C:/Users/allie/Documents/SolTrace/small-system-coordinates_rotated.csv");
        ...
        */
        ...
        writeVectorToCSV("test-small-scene.csv", hp_output_buffer);
